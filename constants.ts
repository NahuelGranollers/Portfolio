...
export const VIDEOS: Video[] = [
	...
	},
  {
    ...
    externalLink: 'https://codebreak.onrender.com' // ← Link al juego en vivo
  },
  {
	id: 6,
...
export const PERSONAL_INFO = {
  ...
  social: {
    email: 'nahuelgranollers@gmail.com', // ⚠️ Actualiza con tu email real
    linkedin: 'https://www.linkedin.com/in/nahuelgranollers', // ⚠️ Actualiza con tu perfil
  }
};
...
export const SERVICES = [
  ...
  },
  {
    ...
    description: 'Animaciones de logotipos, títulos animados y gráficos en movimiento para contenido dinámico.',
    icon: '✨'
  },
  {
